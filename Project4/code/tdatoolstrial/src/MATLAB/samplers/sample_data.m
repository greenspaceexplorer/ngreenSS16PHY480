function [X, labels, t] = sample_data(dataname, n, d, noise)

%SAMPLE_DATA Generates an artificial dataset
%changed by Paul Bendich, Mar 2012.
%new input d specifies ambient dimension for (d-1)-dimensional swiss roll
...
% University California, San Diego / Delft University of Technology
	...
	switch dataname
        case 'swiss'
            ...
            height = 4 * rand(n, d-2);
            X = [t .* cos(t), t .* sin(t), height] + noise * randn(n, d);
            labels = uint8(t);
